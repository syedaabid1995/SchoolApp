...
export const PLAN_PERMISSION_MODULES: PlanPermissionModuleDefinition[] = [
  ...
  },
  {
    ...
    codes: ['homework.view', 'reports.homework.view'],
  },
  {
  ...
  },
  {
    ...
    codes: ['transport.view', 'reports.transport.view'],
  },
  {
    parent: 'Library',
    module: 'Library',
    ...
    codes: ['library.view', 'reports.library.view'],
  },
  {
    parent: 'Inventory',
    module: 'Dormitory',
    ...
    codes: ['dormitory.view', 'reports.dormitory.view'],
  },
  {
    parent: 'Accounts',
    module: 'Accounts',

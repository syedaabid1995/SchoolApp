...
const DEFAULT_PERMISSION_BY_ROLE: Record<ManagedEmployeeRole, string[]> = {
  ...
  ACCOUNTANT: [P.dashboardOverview, P.studentsList, P.feesOverviewView, P.feesInvoicesView, P.feesCollectionView, P.feesCollectionCreate, P.feesReceiptsPrint, P.feesLedgerView, P.feesReportsView, P.feesReportsExport, P.leaveTypeView, P.leaveApplyView, P.leaveApplyCreate, P.leaveApplyEdit, P.leaveApplyDelete, P.leaveBalanceView, P.idcardsView, P.supportView, P.plansView],
...
const LEGACY_FEE_PERMISSION_EXPANSIONS: Record<string, string[]> = {
  ...
  [P.feesCreate]: [
    P.feesParticularsCreate,
    P.feesTypesCreate,
    P.feesStructuresCreate,
    P.feesAssignmentsCreate,
    P.feesInvoiceGenerateCreate,
    P.feesCollectionCreate,
    P.feesDiscountsCreate,
    P.feesFinesCreate,
  ],
  [P.feesEdit]: [
    P.feesParticularsUpdate,
    P.feesTypesUpdate,
    P.feesStructuresUpdate,
    P.feesAssignmentsUpdate,
  ...
  [P.feesDelete]: [
    P.feesParticularsDelete,
    P.feesTypesDelete,
    P.feesStructuresDelete,
    P.feesAssignmentsDelete,
    P.feesDiscountsDelete,
    P.feesFinesDelete,
    P.feesInvoicesCancel,
  ],
  [P.feesCollect]: [
    P.feesInvoicesView,
    P.feesCollectionView,

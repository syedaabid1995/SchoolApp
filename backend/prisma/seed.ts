...
const PERMISSION_CATALOG = [
  ...
  { code: 'fees.view', description: 'View fee management' },
  { code: 'fees.create', description: 'Create fee setup, assignments, and invoices' },
  { code: 'fees.edit', description: 'Edit fee setup and invoices' },
  { code: 'fees.delete', description: 'Delete fee setup records' },
  { code: 'fees.collect', description: 'Collect fee payments' },
  { code: 'fees.report', description: 'View fee reports' },

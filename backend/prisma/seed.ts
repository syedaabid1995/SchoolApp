...
const DEFAULT_ROLE_PERMISSION_CODES: Record<RoleName, string[]> = {
  ...
  ACCOUNTANT: ['dashboard.overview', 'students.list', 'leave.type.view', 'leave.apply.view', 'leave.apply.create', 'leave.apply.edit', 'leave.apply.delete', 'leave.balance.view', 'idcards.view', 'support.view', 'plans.view'],

...
const PERMISSION_CATALOG = [
  ...
  { code: 'reports.view', description: 'View reports catalog and report data' },
  { code: 'reports.export', description: 'Export reports as CSV or PDF' },
  { code: 'reports.students.view', description: 'View student reports' },
  { code: 'reports.parents.view', description: 'View parent reports' },
  { code: 'reports.attendance.view', description: 'View attendance reports' },
  { code: 'reports.exams.view', description: 'View exam reports' },
  { code: 'reports.staff.view', description: 'View staff reports' },
  { code: 'reports.academics.view', description: 'View academic operation reports' },
  { code: 'reports.homework.view', description: 'View homework reports' },
  { code: 'reports.library.view', description: 'View library reports' },
  { code: 'reports.transport.view', description: 'View transport reports' },
  { code: 'reports.dormitory.view', description: 'View dormitory reports' },
  { code: 'reports.fees.view', description: 'View fee reports' },
  { code: 'reports.payroll.view', description: 'View payroll reports' },
  { code: 'compliance.view', description: 'View compliance requests and jobs' },
  { code: 'compliance.review', description: 'Review compliance requests' },
  { code: 'compliance.export.review', description: 'Approve or reject data export requests' },
  { code: 'compliance.deletion.review', description: 'Approve or reject data deletion requests' },
  { code: 'plans.view', description: 'Subscription plan access' },
  { code: 'ai.assistant.view', description: 'View AI assistant' },
  { code: 'ai.assistant.use', description: 'Use AI assistant chat' },
  { code: 'ai.assistant.execute', description: 'Execute confirmed AI assistant actions' },
  { code: 'ai.assistant.admin', description: 'Administer AI assistant settings' },
  { code: 'settings.access', description: 'Access control settings' },
  { code: 'school.onboarding.view', description: 'View school onboarding readiness' },
  { code: 'school.onboarding.manage', description: 'Manage school onboarding checklist' },
  { code: 'school.onboarding.review', description: 'Review and approve school onboarding go-live' },
  { code: 'teacher.onboarding.view', description: 'View teacher onboarding readiness' },
  { code: 'teacher.onboarding.manage', description: 'Manage teacher onboarding readiness' },
  { code: 'teacher.credentials.manage', description: 'Manage teacher credential delivery' },
  { code: 'teachers.list', description: 'Employee list access' },
  { code: 'teachers.add', description: 'Employee creation access' },
  { code: 'staff.view', description: 'View staff directory' },
  { code: 'staff.create', description: 'Create staff profiles' },
  { code: 'staff.edit', description: 'Edit staff profiles' },
  { code: 'staff.delete', description: 'Delete staff profiles' },
  { code: 'staff.document.view', description: 'View staff documents' },
  { code: 'staff.document.create', description: 'Upload staff documents' },
  { code: 'staff.document.delete', description: 'Delete staff documents' },
  { code: 'staff.timeline.view', description: 'View staff timeline' },
  { code: 'staff.timeline.create', description: 'Create staff timeline entries' },
  { code: 'staff.timeline.delete', description: 'Delete staff timeline entries' },
  { code: 'academics.setup', description: 'Academic setup access' },
  { code: 'academic.class.view', description: 'View class management' },
  { code: 'academic.class.create', description: 'Create classes' },
  { code: 'academic.class.edit', description: 'Edit classes' },
  { code: 'academic.class.delete', description: 'Delete classes' },
  { code: 'academic.section.view', description: 'View section management' },
  { code: 'academic.section.create', description: 'Create sections' },
  { code: 'academic.section.edit', description: 'Edit sections' },
  { code: 'academic.section.delete', description: 'Delete sections' },
  { code: 'academic.subject.view', description: 'View subject management' },
  { code: 'academic.subject.create', description: 'Create subjects' },
  { code: 'academic.subject.edit', description: 'Edit subjects' },
  { code: 'academic.subject.delete', description: 'Delete subjects' },
  { code: 'academic.room.view', description: 'View classroom management' },
  { code: 'academic.room.create', description: 'Create classrooms' },
  { code: 'academic.room.edit', description: 'Edit classrooms' },
  { code: 'academic.room.delete', description: 'Delete classrooms' },
  { code: 'academic.time.view', description: 'View time period management' },
  { code: 'academic.time.create', description: 'Create time periods' },
  { code: 'academic.time.edit', description: 'Edit time periods' },
  { code: 'academic.time.delete', description: 'Delete time periods' },
  { code: 'academic.assign_subject.view', description: 'View subject assignments' },
  { code: 'academic.assign_subject.create', description: 'Create subject assignments' },
  { code: 'academic.assign_subject.edit', description: 'Edit subject assignments' },
  { code: 'academic.assign_subject.delete', description: 'Delete subject assignments' },
  { code: 'academic.class_teacher.view', description: 'View class teacher assignments' },
  { code: 'academic.class_teacher.create', description: 'Create class teacher assignments' },
  { code: 'academic.class_teacher.edit', description: 'Edit class teacher assignments' },
  { code: 'academic.class_teacher.delete', description: 'Delete class teacher assignments' },
  { code: 'academic.routine.view', description: 'View class routines' },
  { code: 'academic.routine.create', description: 'Create class routines' },
  { code: 'academic.routine.edit', description: 'Edit class routines' },
  { code: 'academic.routine.delete', description: 'Delete class routines' },
  { code: 'academics.exams', description: 'Exam management access' },
  { code: 'exam.center.view', description: 'View exam centers' },
  { code: 'exam.center.manage', description: 'Manage exam centers' },
  { code: 'exam.room.view', description: 'View exam rooms' },
  { code: 'exam.room.manage', description: 'Manage exam rooms' },
  { code: 'exam.seating.view', description: 'View exam seating' },
  { code: 'exam.seating.manage', description: 'Manage exam seating' },
  { code: 'exam.invigilator.view', description: 'View exam invigilators' },
  { code: 'exam.invigilator.manage', description: 'Manage exam invigilators' },
  { code: 'exam.hallticket.view', description: 'View exam hall tickets' },
  { code: 'exam.hallticket.export', description: 'Export exam hall tickets' },
  ...
  { code: 'student.view', description: 'View student information' },
  { code: 'student.create', description: 'Create student admissions' },
  { code: 'student.edit', description: 'Edit student information' },
  { code: 'student.delete', description: 'Delete student records' },
  { code: 'student.import', description: 'Bulk import students' },
  { code: 'student.document.view', description: 'View student documents' },
  { code: 'student.document.create', description: 'Upload student documents' },
  { code: 'student.document.delete', description: 'Delete student documents' },
  { code: 'student.timeline.view', description: 'View student timeline' },
  { code: 'student.timeline.create', description: 'Create student timeline entries' },
  { code: 'student.timeline.delete', description: 'Delete student timeline entries' },
  { code: 'attendance.create', description: 'Create student attendance' },
  { code: 'attendance.edit', description: 'Edit student attendance' },
  { code: 'attendance.report', description: 'View student attendance reports' },
  { code: 'staff.attendance.view', description: 'View staff attendance' },
  { code: 'staff.attendance.create', description: 'Create staff attendance' },
  { code: 'staff.attendance.edit', description: 'Edit staff attendance' },
  { code: 'staff.attendance.report', description: 'View staff attendance reports' },
  { code: 'leave.type.view', description: 'View leave types' },
  { code: 'leave.type.create', description: 'Create leave types' },
  { code: 'leave.type.edit', description: 'Edit leave types' },
  { code: 'leave.type.delete', description: 'Delete leave types' },
  { code: 'leave.define.view', description: 'View role-wise leave definitions' },
  { code: 'leave.define.create', description: 'Create role-wise leave definitions' },
  { code: 'leave.define.edit', description: 'Edit role-wise leave definitions' },
  { code: 'leave.define.delete', description: 'Delete role-wise leave definitions' },
  { code: 'leave.apply.view', description: 'View own leave applications' },
  { code: 'leave.apply.create', description: 'Apply for leave' },
  { code: 'leave.apply.edit', description: 'Edit own leave applications' },
  { code: 'leave.apply.delete', description: 'Delete own leave applications' },
  { code: 'leave.approve.view', description: 'View staff leave requests' },
  { code: 'leave.approve.edit', description: 'Approve or reject leave requests' },
  { code: 'leave.approve.delete', description: 'Delete leave requests' },
  { code: 'leave.balance.view', description: 'View leave balances' },
  { code: 'fees.overview.view', description: 'Fee permission' },
  { code: 'fees.particulars.view', description: 'Fee permission' },
  { code: 'fees.particulars.create', description: 'Fee permission' },
  { code: 'fees.particulars.update', description: 'Fee permission' },
  { code: 'fees.particulars.delete', description: 'Fee permission' },
  { code: 'fees.types.view', description: 'Fee permission' },
  { code: 'fees.types.create', description: 'Fee permission' },
  { code: 'fees.types.update', description: 'Fee permission' },
  { code: 'fees.types.delete', description: 'Fee permission' },
  { code: 'fees.structures.view', description: 'Fee permission' },
  { code: 'fees.structures.create', description: 'Fee permission' },
  { code: 'fees.structures.update', description: 'Fee permission' },
  { code: 'fees.structures.delete', description: 'Fee permission' },
  { code: 'fees.assignments.view', description: 'Fee permission' },
  { code: 'fees.assignments.create', description: 'Fee permission' },
  { code: 'fees.assignments.update', description: 'Fee permission' },
  { code: 'fees.assignments.delete', description: 'Fee permission' },
  { code: 'fees.invoice-generate.view', description: 'Fee permission' },
  { code: 'fees.invoice-generate.create', description: 'Fee permission' },
  { code: 'fees.invoices.view', description: 'Fee permission' },
  { code: 'fees.invoices.cancel', description: 'Fee permission' },
  { code: 'fees.collection.view', description: 'Fee permission' },
  { code: 'fees.collection.create', description: 'Fee permission' },
  { code: 'fees.receipts.print', description: 'Fee permission' },
  { code: 'fees.discounts.view', description: 'Fee permission' },
  { code: 'fees.discounts.create', description: 'Fee permission' },
  { code: 'fees.discounts.update', description: 'Fee permission' },
  { code: 'fees.discounts.delete', description: 'Fee permission' },
  { code: 'fees.fines.view', description: 'Fee permission' },
  { code: 'fees.fines.create', description: 'Fee permission' },
  { code: 'fees.fines.update', description: 'Fee permission' },
  { code: 'fees.fines.delete', description: 'Fee permission' },
  { code: 'fees.ledger.view', description: 'Fee permission' },
  { code: 'fees.reports.view', description: 'Fee permission' },
  { code: 'fees.reports.export', description: 'Fee permission' },
  { code: 'payroll.view', description: 'View payroll' },
  { code: 'payroll.generate', description: 'Generate payroll' },
  { code: 'payroll.pay', description: 'Record payroll payment' },
  { code: 'payroll.report', description: 'View payroll reports' },
  { code: 'student.group.view', description: 'View student groups' },
  { code: 'student.group.create', description: 'Create student groups' },
  { code: 'student.group.edit', description: 'Edit student groups' },
  { code: 'student.group.delete', description: 'Delete student groups' },
  { code: 'student.category.view', description: 'View student categories' },
  { code: 'student.category.create', description: 'Create student categories' },
  { code: 'student.category.edit', description: 'Edit student categories' },
  { code: 'student.category.delete', description: 'Delete student categories' },
  { code: 'student.promote.view', description: 'View student promotion' },
  { code: 'student.promote.create', description: 'Promote students' },
  { code: 'student.disabled.view', description: 'View disabled students' },
  { code: 'student.disabled.edit', description: 'Edit disabled students' },
  { code: 'student.disabled.delete', description: 'Delete disabled students' },
  { code: 'student.disabled.restore', description: 'Restore disabled students' },
  ...
  { code: 'communication.notice_board.view', description: 'View notice board' },
  { code: 'communication.notice_board.create', description: 'Create notices' },
  { code: 'communication.notice_board.edit', description: 'Edit notices' },
  { code: 'communication.notice_board.delete', description: 'Delete notices' },
  { code: 'communication.email.send', description: 'Send email communication' },
  { code: 'communication.sms.send', description: 'Send SMS communication' },
  { code: 'communication.push.send', description: 'Send push notifications' },
  { code: 'communication.email_sms_log.view', description: 'View email and SMS logs' },
  { code: 'communication.push_log.view', description: 'View push notification logs' },
  { code: 'communication.scheduled_log.view', description: 'View scheduled communication logs' },
  { code: 'communication.login_credentials.send', description: 'Send login credential instructions' },
  { code: 'communication.email_template.view', description: 'View email templates' },
  { code: 'communication.email_template.create', description: 'Create email templates' },
  { code: 'communication.email_template.edit', description: 'Edit email templates' },
  { code: 'communication.email_template.delete', description: 'Delete email templates' },
  { code: 'communication.sms_template.view', description: 'View SMS templates' },
  { code: 'communication.sms_template.create', description: 'Create SMS templates' },
  { code: 'communication.sms_template.edit', description: 'Edit SMS templates' },
  { code: 'communication.sms_template.delete', description: 'Delete SMS templates' },
  { code: 'communication.push_template.view', description: 'View push templates' },
  { code: 'communication.push_template.create', description: 'Create push templates' },
  { code: 'communication.push_template.edit', description: 'Edit push templates' },
  { code: 'communication.push_template.delete', description: 'Delete push templates' },

...
class TeacherAttendanceCalendarScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final byDay = {
      for (final record in records) record.date.day: record.status,
    };
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.calendar_today_outlined, color: colorScheme.onPrimary, size: 20),
                ),
            ...
            child: Column(
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    _LegendDot(color: const Color(0xFF2E7D32), label: 'Present'),
                    _LegendDot(color: const Color(0xFFC62828), label: 'Absent'),
                    _LegendDot(color: const Color(0xFFF57F17), label: 'Late'),
                    _LegendDot(color: const Color(0xFFE65100), label: 'Half day'),
                  ],
                ),
              ],
            ),
